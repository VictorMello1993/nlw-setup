...
export function ScrollBarArea({ children }: ScrollAreaProps) {
  return (
    <ScrollArea.Root>
      <ScrollArea.Viewport>
        {children}
      ...
      <ScrollArea.Scrollbar
        className="flex select-none touch-none p-0.5 bg-black/60 transition-colors duration-150 ease-out hover:bg-black/80 w-2.5 rounded-lg mt-7"
